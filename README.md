...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* --- New Languages & Achievements Layout Adjustments --- */
.awards-list {
  list-style: none;
  display: flex;
...
/* Styled Professional Language Badges (No Progress Bars) */
.lang-badge-list {
  display: flex;
  flex-direction: column;
  gap: 14px;
...
<body>
  ...
  <strong>Currently seeking:</strong> A <strong> 5-month internship</strong>
  ...
  <strong>English Teaching Intern</strong>,
  <strong>Teaching Assistant</strong>, Student Support, Social Media, or Communications opportunities.
</p>
  ...
  <i class="fas fa-download" style="margin-right: 5px;"></i> Download CV
    ...
    <!-- Languages & Achievements Section Split -->
    ...
    <div class="skills-category">
      ...
      <div class="lang-badge-list">
        <div class="lang-card">
          ...
          <span class="lang-level">Fluent / Academic</span>
        </div>

        <div class="lang-card">
          <div class="lang-info">
            <i class="fas fa-check-circle"></i>
            <span class="lang-name">Myanmar (Burmese)</span>
          </div>
